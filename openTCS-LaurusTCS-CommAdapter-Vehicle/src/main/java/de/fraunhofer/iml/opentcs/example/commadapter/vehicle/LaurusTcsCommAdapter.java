...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.LaurusTcsProcessModelTO;
 ...
 */
public class LaurusTcsCommAdapter
   ...
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LaurusTcsCommAdapter.class);
  /**
   ...
   */
  private final LaurusTcsAdapterComponentsFactory componentsFactory;
  /**
   ...
   */
  @Inject
  public LaurusTcsCommAdapter(@Assisted Vehicle vehicle,
                            OrderMapper orderMapper,
                            LaurusTcsAdapterComponentsFactory componentsFactory) {
    super(new LaurusTcsProcessModel(vehicle), 3, 1, LoadAction.CHARGE);
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (!(evt.getSource() instanceof LaurusTcsProcessModel)) {
      return;
    }
    ...
    if (Objects.equals(evt.getPropertyName(),
        ...
        || Objects.equals(evt.getPropertyName(),
                          LaurusTcsProcessModel.Attribute.PERIODIC_STATE_REQUESTS_ENABLED.name())) {
      if (getProcessModel().isCommAdapterConnected()
    ...
    if (Objects.equals(evt.getPropertyName(),
                       LaurusTcsProcessModel.Attribute.PERIOD_STATE_REQUESTS_INTERVAL.name())) {
  ...
  @Override
  public final LaurusTcsProcessModel getProcessModel() {
    return (LaurusTcsProcessModel) super.getProcessModel();
  }
  ...
  protected VehicleProcessModelTO createCustomTransferableProcessModel() {
    ...
    //plant overview
    return new LaurusTcsProcessModelTO()
