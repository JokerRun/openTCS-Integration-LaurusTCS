 ...
 */
public interface LaurusTcsAdapterComponentsFactory {

  /**
   * Creates a new LaurusTcsCommAdapter for the given vehicle.
   *
   * @param vehicle The vehicle
   * @return A new LaurusTcsCommAdapter for the given vehicle
   */
  LaurusTcsCommAdapter createLaurusTcsCommAdapter(Vehicle vehicle);
