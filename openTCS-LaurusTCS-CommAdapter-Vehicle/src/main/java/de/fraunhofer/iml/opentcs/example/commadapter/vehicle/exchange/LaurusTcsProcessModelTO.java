...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.LaurusTcsProcessModel;
...
/**
 * A serializable representation of a {@link LaurusTcsProcessModel}.
 ...
 */
public class LaurusTcsProcessModelTO
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public LaurusTcsProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
