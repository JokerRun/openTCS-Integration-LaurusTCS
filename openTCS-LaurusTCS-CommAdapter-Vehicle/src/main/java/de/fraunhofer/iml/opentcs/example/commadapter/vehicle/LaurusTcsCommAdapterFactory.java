...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.LaurusTcsCommAdapterDescription;
...
public class LaurusTcsCommAdapterFactory
    implements VehicleCommAdapterFactory {

  /**
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LaurusTcsCommAdapterFactory.class);
   ...
   */
  @Inject
  public LaurusTcsCommAdapterFactory(LaurusTcsAdapterComponentsFactory componentsFactory) {
  ...
  public VehicleCommAdapterDescription getDescription() {
    return new LaurusTcsCommAdapterDescription();
  }
  ...
  public VehicleCommAdapter getAdapterFor(Vehicle vehicle) {
    ...
    LaurusTcsCommAdapter adapter = componentsFactory.createLaurusTcsCommAdapter(vehicle);
