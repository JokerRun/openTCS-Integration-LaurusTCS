 ...
 */
public class LaurusTcsCommAdapterFactoryTest {

  private LaurusTcsCommAdapterFactory commAdapterFactory;

  @Before
  public void setUp() {
    commAdapterFactory = new LaurusTcsCommAdapterFactory(mock(LaurusTcsAdapterComponentsFactory.class));
  }
